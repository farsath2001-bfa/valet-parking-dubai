...
export const HOW_IT_WORKS = [
  {
    ...
    title: "Arrival",
    description:
      "Guest drives up to the valet podium. A uniformed attendant greets them and opens the door.",
  },
  {
    step: "02",
...
export const CLIENTS = [
  ...
  { name: "Mall of Emirates", logo: "mall-of-emirates.png" },
  { name: "Dubai International Airport", logo: "dxb.png" },
